...
dir = './training_and_test_data/'
init_process(dir + 'training.1600000.processed.noemoticon.csv', 'train_set.csv')
init_process(dir + 'testdata.manual.2009.06.14.csv', 'test_set.csv')
